...
def read_data(dataset, idx, is_train=True):
    if is_train:
        ...
        if dataset == 'adult' or dataset ==  'smart_grid':
            train_data = np.load(train_file, allow_pickle=True)['data'].tolist()
            # with open(train_file, 'rb') as f:
            #     train_data = np.load(f, allow_pickle=True).tolist()
        else:
            with open(train_file, 'rb') as f:
        ...
        if dataset == 'adult' or 'smart_grid':
            test_data = np.load(test_file, allow_pickle=True)['data'].tolist()
        else:
