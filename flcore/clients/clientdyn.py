...
class clientDyn(Client):
     ...
     def train(self, cou, data_poison=False,model_poison=False):
          ...
          for step in range(max_local_steps):
               for i, (x, y) in enumerate(trainloader):
                    ...
                    if self.global_model_vector != None:
                         ...
                         loss += self.alpha_dyn/2 * torch.norm(v1 - self.global_model_vector, 2)
          ...
          if self.global_model_vector != None:
               ...
               self.old_grad = self.old_grad - self.alpha_dyn * (v1 - self.global_model_vector)
